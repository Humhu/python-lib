...
class NetworkCoordinator(object):
    ...
    def __init__(self, callback):
        ...
        self.localAddress = network_const.DISCOVERY_SERVER_ADDR
        self.localPAN = network_const.DISCOVERY_SERVER_PAN
        self.localChannel = network_const.DISCOVERY_CHANNEL
        
        # Assigning address parameters
        self.activeServerAddress = network_const.ACTIVE_SERVER_ADDR
        self.activeServerPAN = network_const.ACTIVE_SERVER_PAN
        #self.activeClientAddress is assigned dynamically
        self.activeClientPAN = network_const.ACTIVE_CLIENT_PAN
        self.activeChannel = network_const.ACTIVE_CHANNEL
